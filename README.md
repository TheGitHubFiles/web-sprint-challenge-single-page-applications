...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for. matches current path in url
1. How would you explain form validation to someone who has never programmed before? validating your inputs so people dont mess them up by accident
1. In 1-2 sentences, define end to end testing. end to end testing is testing that acts like a user and validates the site is working
